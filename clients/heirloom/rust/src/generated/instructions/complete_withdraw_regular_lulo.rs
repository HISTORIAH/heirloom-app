...
pub const COMPLETE_WITHDRAW_REGULAR_LULO_DISCRIMINATOR: [u8; 8] =
...
impl CompleteWithdrawRegularLulo {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = CompleteWithdrawRegularLuloInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl CompleteWithdrawRegularLuloBuilder {
    ...
    /// CHECK: Lulo CPI
    #[inline(always)]
    pub fn pending_withdrawal_account(
        &mut self,
        pending_withdrawal_account: solana_address::Address,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = CompleteWithdrawRegularLulo {
            ...
            pending_withdrawal_account: self
                .pending_withdrawal_account
                .expect("pending_withdrawal_account is not set"),
        ...
        let args = CompleteWithdrawRegularLuloInstructionArgs {
            withdrawal_id: self
                .withdrawal_id
                .clone()
                .expect("withdrawal_id is not set"),
        };
...
impl<'a, 'b> CompleteWithdrawRegularLuloCpiBuilder<'a, 'b> {
    ...
    pub fn pending_withdrawal_account(
        &mut self,
        pending_withdrawal_account: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
