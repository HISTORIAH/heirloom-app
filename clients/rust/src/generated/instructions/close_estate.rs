...
pub const CLOSE_ESTATE_DISCRIMINATOR: [u8; 1] = [8];
...
impl CloseEstate {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let data = CloseEstateInstructionData::new().try_to_vec().unwrap();
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
 pub struct CloseEstateInstructionData {
            discriminator: [u8; 1],
      }

impl CloseEstateInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [8],
                  }
...
impl Default for CloseEstateInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `CloseEstate`.
///
/// ### Accounts:
///
...
#[inline(always)]
  ...
  /// `close_estate` CPI accounts.
  pub struct CloseEstateCpiAccounts<'a, 'b> {
...
/// `close_estate` CPI instruction.
pub struct CloseEstateCpi<'a, 'b> {
...
impl<'a, 'b> CloseEstateCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: CloseEstateCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `CloseEstate` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` authority
...
impl<'a, 'b> CloseEstateCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(CloseEstateCpiBuilderInstruction {
      __program: program,
              authority: None,
              heir: None,
              estate: None,
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = CloseEstateCpi {
...
#[derive(Clone, Debug)]
struct CloseEstateCpiBuilderInstruction<'a, 'b> {
