...
export const VAULT_CLAIM_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  248, 247, 50, 35, 235, 238, 104, 183,
]);

export function getVaultClaimDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(VAULT_CLAIM_DISCRIMINATOR);
}

export type VaultClaimInstruction<
...
export type VaultClaimInstructionData = { discriminator: ReadonlyUint8Array };

export type VaultClaimInstructionDataArgs = {};

export function getVaultClaimInstructionDataEncoder(): FixedSizeEncoder<VaultClaimInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([["discriminator", fixEncoderSize(getBytesEncoder(), 8)]]),
    (value) => ({ ...value, discriminator: VAULT_CLAIM_DISCRIMINATOR }),
  );
}

export function getVaultClaimInstructionDataDecoder(): FixedSizeDecoder<VaultClaimInstructionData> {
  return getStructDecoder([["discriminator", fixDecoderSize(getBytesDecoder(), 8)]]);
}

export function getVaultClaimInstructionDataCodec(): FixedSizeCodec<
  VaultClaimInstructionDataArgs,
  VaultClaimInstructionData
> {
  return combineCodec(getVaultClaimInstructionDataEncoder(), getVaultClaimInstructionDataDecoder());
}
...
export function getVaultClaimInstruction<
  TAccountDestination extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getVaultClaimInstructionDataEncoder().encode({}),
    programAddress,
  } as VaultClaimInstruction<
    TProgramAddress,
    TAccountDestination,
    TAccountMint,
    TAccountVaultTokenAccount,
...
export type ParsedVaultClaimInstruction<
  TProgram extends string = typeof HEIRLOOM_STOCKS_PROGRAM_ADDRESS,
...
> = {
  ...
  data: VaultClaimInstructionData;
};

export function parseVaultClaimInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>,
): ParsedVaultClaimInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getVaultClaimInstructionDataDecoder().decode(instruction.data),
  };
}
