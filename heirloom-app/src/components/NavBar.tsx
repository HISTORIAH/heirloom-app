          ...
          <div className="p-6 space-y-4">
            {isConnected ? (
              <>
                ...
                <Button variant="default" size="lg" className="w-full" onClick={() => { setOpen(false); navigate("/dashboard"); }}>
                  Dashboard
                </Button>
                <Button variant="orange" size="lg" className="w-full" onClick={() => { setOpen(false); navigate("/claim"); }}>
                  Claim Inheritance
                </Button>
                <Button variant="ghost" size="lg" className="w-full" onClick={() => { setOpen(false); disconnectWallet(); }}>
                  Disconnect
                </Button>
              </>
            ) : (
              <Button variant="default" size="lg" className="w-full" onClick={() => { setOpen(false); handleLaunch(); }}>
                Launch App
              </Button>
            )}
          </div>
